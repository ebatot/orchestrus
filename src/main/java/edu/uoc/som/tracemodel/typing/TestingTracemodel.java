...
import edu.uoc.som.tracemodel.Artefact;
import edu.uoc.som.tracemodel.ArtefactFragment;
import edu.uoc.som.tracemodel.Trace;
import edu.uoc.som.tracemodel.TraceLink;
...
public class TestingTracemodel {
	...
	public static void testClosure() {
		...
		ArtefactType typeCode    = ArtefactTypeFactory.getInstance().addType("CodeType");
		ArtefactType typeDesign  = ArtefactTypeFactory.getInstance().addType("DesignType");
		ArtefactType typePalette = ArtefactTypeFactory.getInstance().addType("PaletteType");
		ArtefactType typeEltType = ArtefactTypeFactory.getInstance().addType("ETCType");
	...
	public void testTrace_1() {
		...
		ArtefactFragment afCode1_1 = new ArtefactFragment(artCode1);
		ArtefactFragment afCode1_2 = new ArtefactFragment(artCode1);
		ArtefactFragment afCode2_1 = new ArtefactFragment(artCode2);
		ArtefactFragment afDesg1_1 = new ArtefactFragment(artDesg1);
